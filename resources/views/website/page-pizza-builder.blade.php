                                            ...
                                            <div class="js-hidden-box sause-list uk-grid uk-child-width-1-3@s uk-child-width-1-2" data-uk-grid>
                                                <div>
                                                    <div class="sause-item">
                                                        <div class="js-checkbox sause-item__box"><span class="sause-item__content"><span class="sause-item__media"><img loading="lazy" data-lazy="true"  src="{{asset('website-assets/img/pages/builder/souse-1.jpg')}}" alt="souse"></span><span class="sause-item__title">Ranch</span><span class="sause-item__desc">A cool, perfect blend of herbs and spices.</span><span class="sause-item__price">$5.50</span></span></div>
                                                    </div>
                                                </div>
                                                <div>
                                                    <div class="sause-item">
                                                        <div class="js-checkbox sause-item__box"><span class="sause-item__content"><span class="sause-item__media"><img loading="lazy" data-lazy="true"  src="{{asset('website-assets/img/pages/builder/souse-2.jpg')}}" alt="souse"></span><span class="sause-item__title">Blue Cheese</span><span class="sause-item__desc">Creamy blue cheese packed with flavor in every dip.</span><span class="sause-item__price">$5.50</span></span></div>
                                                    </div>
                                                </div>
                                                <div>
                                                    <div class="sause-item">
                                                        <div class="js-checkbox sause-item__box"><span class="sause-item__content"><span class="sause-item__media"><img loading="lazy" data-lazy="true"  src="{{asset('website-assets/img/pages/builder/souse-3.jpg')}}" alt="souse"></span><span class="sause-item__title">Marinara</span><span class="sause-item__desc">All the flavor of Italian pizza sauce for dipping.</span><span class="sause-item__price">$5.50</span></span></div>
                                                    </div>
                                                </div>
                                                <div>
                                                    <div class="sause-item">
                                                        <div class="js-checkbox sause-item__box"><span class="sause-item__content"><span class="sause-item__media"><img loading="lazy" data-lazy="true"  src="{{asset('website-assets/img/pages/builder/souse-4.jpg')}}" alt="souse"></span><span class="sause-item__title">Garlic</span><span class="sause-item__desc">A cool, perfect blend of herbs and spices.</span><span class="sause-item__price">$5.50</span></span></div>
                                                    </div>
                                                </div>
                                                <div>
                                                    <div class="sause-item">
                                                        <div class="js-checkbox sause-item__box"><span class="sause-item__content"><span class="sause-item__media"><img loading="lazy" data-lazy="true"  src="{{asset('website-assets/img/pages/builder/souse-5.jpg')}}" alt="souse"></span><span class="sause-item__title">Barbeque</span><span class="sause-item__desc">Creamy blue cheese packed with flavor in every dip.</span><span class="sause-item__price">$5.50</span></span></div>
                                                    </div>
                                                </div>
                                                <div>
                                                    <div class="sause-item">
                                                        <div class="js-checkbox sause-item__box"><span class="sause-item__content"><span class="sause-item__media"><img loading="lazy" data-lazy="true"  src="{{asset('website-assets/img/pages/builder/souse-6.jpg')}}" alt="souse"></span><span class="sause-item__title">Cheese</span><span class="sause-item__desc">All the flavor of Italian pizza sauce for dipping.</span><span class="sause-item__price">$5.50</span></span></div>
                                                    </div>
                                                </div>
                                                <div>
                                                    <div class="sause-item">
