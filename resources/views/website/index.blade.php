                   ...
                   <div class="col-md-6 wow fadeInUp" data-wow-delay="200ms">
                       <div class="banner-item">
                            ...
                            <div class="banner-content">
                                ...
                                <a href="{{url('item/'.$menu['homeitem'][0]->category_id.'/'.$menu['homeitem'][0]->item_id)}}"@auth @if(!session()->has('branch_id')) data-toggle="modal" data-target="#service-modal" @endif @endauth class="order-btn cart">@lang('general.Order Now')</a>
                            </div>
                        </div>
                   </div>
                    <div class="col-md-6">
                       <div class="row">
                           ...
                           <div class="banner-item">
                            ...
                            <div class="banner-content">
                                ...
                                <a href="{{url('item/'.$menu['homeitem'][1]->category_id.'/'.$menu['homeitem'][1]->item_id)}}"  @auth @if(!session()->has('branch_id')) data-toggle="modal" data-target="#service-modal" @endif @endauth class="order-btn cart">@lang('general.Order Now')</a>
                            </div>
                        </div>
                           </div>
                           ...
                           <div class="banner-item">
                            ...
                            <div class="banner-content">
                                ...
                                <a href="{{url('item/'.$menu['homeitem'][2]->category_id.'/'.$menu['homeitem'][2]->item_id)}}" @auth @if(!session()->has('branch_id')) data-toggle="modal" data-target="#service-modal" @endif @endauth class="order-btn cart">@lang('general.Order Now')</a>
                            </div>
                        </div>
                           </div>
                           ...
                           <div class="banner-item">
                            ...
                            <div class="banner-content">
                                ...
                                <a href="{{url('item/'.$menu['homeitem'][3]->category_id.'/'.$menu['homeitem'][3]->item_id)}}" @auth @if(!session()->has('branch_id')) data-toggle="modal" data-target="#service-modal" @endif @endauth class="order-btn cart">@lang('general.Order Now')</a>
                            </div>
                        </div>
                           </div>
                       </div>
